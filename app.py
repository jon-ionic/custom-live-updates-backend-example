...
@app.route("/ui/apps", methods=["GET", "POST"])
def ui_apps():
...
@app.route("/ui/apps/<app_id>", methods=["GET", "POST"])
def ui_app(app_id):
...
@app.route("/ui/apps/<app_id>/builds", methods=["GET", "POST"])
...
@app.route("/ui/apps/<app_id>/deployments", methods=["GET", "POST"])
