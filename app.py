...
def create_build(app_id: str):
    ...
    If the build is a differential update, the "artifact_url" will point to the 
    "live-update-manifest.json" file. If the build is a zip file, the "artifact_url" 
    will point to the zip file.
